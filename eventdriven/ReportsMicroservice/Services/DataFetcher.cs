...
namespace ReportsMicroservice
{
    public class DataFetcher
    {
        ...
        public DataFetcher(PublishingRouter publishingRouter, EventsAwaiter eventsAwaiter)
        {
        ...
        public async Task<Account[]> GetAccounts(string flowId, string userId)
        {
            ...
            var response = await eventsAwaiter.AwaitResponse<SelectedAccountsEvent>(flowId, () => publishingRouter.Publish(Queues.Accounts, payload, flowId, Queues.Reports));
        ...
        public async Task<Payment[]> GetPayments(string flowId, string[] accountsIds)
        {
            ...
            var response = await eventsAwaiter.AwaitResponse<SelectedPaymentsEvent>(flowId, () => publishingRouter.Publish(Queues.Payments, payload, flowId, Queues.Reports));
        ...
        public async Task<Card[]> GetCards(string flowId, string[] accountsIds)
        {
            ...
            var response = await eventsAwaiter.AwaitResponse<SelectedCardsEvent>(flowId, () => publishingRouter.Publish(Queues.Cards, payload, flowId, Queues.Reports));
        ...
        public async Task<Transaction[]> GetTransactions(string flowId, string queue, DateTime? from, DateTime? to)
        {
            ...
            var response = await eventsAwaiter.AwaitResponse<SelectedTransactionsEvent>(flowId, () => publishingRouter.Publish(queue, payload, flowId, Queues.Reports));
            return response.Transactions;
        }

        public async Task<Transaction[]> GetTransactions(string flowId, FilterTransactionsEvent payload)
        {
            var response = await eventsAwaiter.AwaitResponse<SelectedTransactionsEvent>(flowId, () => publishingRouter.Publish(Queues.Transactions, payload, flowId, Queues.Reports));
            return response.Transactions;
        }
    }
}