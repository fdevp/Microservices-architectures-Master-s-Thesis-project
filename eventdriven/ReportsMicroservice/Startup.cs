...
namespace ReportsMicroservice
{
    public class Startup
    {
        ...
        private void ConfigureRabbitMq(IServiceCollection services)
        {
            ...
            var consumer = factory.CreateConsumer(Queues.Reports);
            ...
            var reportsService = servicesProvider.GetService<ReportsService>();

            var consumingRouter = ConsumingRouter<ReportsService>.Create(reportsService, "Reports", logger);
